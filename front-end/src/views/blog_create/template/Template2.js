  ...
  const handleDownload = () => 
  {
    ...
    return (
          ...
          <label for="choosetemplate" className={style.dropdown}>Template</label>
            ...
            <div className={style.temp2} ref={imageRef}>
            <div className={style.title}>
            <textarea id="title" name="title" style={{textDecorationThickness:"100%",border: "0px solid black",width:"140vh",backgroundColor:"whitesmoke",fontSize:"20px"}}></textarea>
            </div>
            ...
            <img src={file1} className={style.im1} style={{left:"0px",top:"0px"}}/>
            ...
            <div contentEditable="true" id="text1" name="text1" style={{width:"46vh",height: "45vh",border: "0px solid black",backgroundColor:"whitesmoke",padding:"10px",fontSize:"20px"}}></div>
            </div>
            <div className={style.im2}>
            <img src={file2} className={style.im2} style={{left:"0px",top:"0px"}}/>
            ...
            <div contenteditable="true" id="text2" name="text2" style={{width:"40vh",height: "45vh",border: "0px solid black",backgroundColor:"whitesmoke",padding:"10px",fontSize:"20px"}}></div>
            </div>
            <div className={style.im3}>
            <img src={file3} className={style.im3} style={{left:"0px",top:"0px"}}/>
            <div className={style.add3}><h1>+</h1>
            <div class={style.dropdown}>
            ...
            <div contenteditable="true" id="text3" name="text3" style={{width:"43vh",height: "40vh",border: "0px solid black",backgroundColor:"whitesmoke",padding:"10px",fontSize:"20px"}}></div>
            </div>
            </div>
            </form>
